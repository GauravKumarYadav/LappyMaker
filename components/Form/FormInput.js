...
const styles = StyleSheet.create({
    inputContainer: { marginTop: wp('3%'), width: wp('87%'), minHeight:hp('7%'),borderColor: '#ccc', borderRadius: wp(5), borderWidth: 1, flexDirection: 'row', alignItems: 'center', backgroundColor: '#fff', },
